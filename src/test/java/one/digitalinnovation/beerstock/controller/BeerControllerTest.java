...
public class BeerControllerTest {
    ...
    @Test
    void whenGETIsCalledWithValidNameThanOkStatusIsReturned() throws Exception {
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenGETIsCalledWithoutThanNotFoundStatusIsReturned() throws Exception {
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenDELETEIsCalledWithValidIdThanNoContentStatusIsReturned() throws Exception {
        //given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenDELETEIsCalledWithInvalidIdThanNotFoundStatusIsReturned() throws Exception {
    ...
    @Test
    void whenPATCHIsCalledToIncrementGreatherThenMaxThenBadRequestStatusIsReturned() throws Exception {
        //when
        QuantityDTO quantityDTO = QuantityDTO.builder()
                .quantity(30)
                .build();
    ...
    @Test
    void whenPATCHIsCalledToDecrementGreatherThenActualStockThenBadRequestStatusIsReturned() throws Exception {
        //when
        QuantityDTO quantityDTO = QuantityDTO.builder()
                .quantity(11)
                .build();
